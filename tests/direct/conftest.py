...
if os.name == "nt":
    ...
    def _windows_refresh_gl_message(self: VMContext) -> None:
        _original_refresh(self)
        # genlayer-test 0.29.2 refreshes sender/origin but leaves the cached
        # raw transaction datetime unchanged after vm.warp().
    ...
    VMContext._refresh_gl_message = _windows_refresh_gl_message
